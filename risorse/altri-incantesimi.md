...
Se gli [incantesimi](/cairn-srd##100-incantesimi) di default di Cairn non sono esattamente corrispondenti a quello che stai cercando, prova a guardare nella seguente tabella d666.
**Nota**: Dai per scontato che i tiri di danno siano sui PF a meno che non sia indicato diversamente (ad esempio, 1d6 danni vs perdi 1d6 FOR).
